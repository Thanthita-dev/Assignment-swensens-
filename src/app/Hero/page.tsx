          ...
          <section className="max-w-6xl mx-auto px-6 py-2 my-10 mt-25">
            ...
            <div className="mt-5">
              <img
                ...
                src="https://www.swensens1112.com/_next/image?url=https%3A%2F%2Ffirebasestorage.googleapis.com%2Fv0%2Fb%2Fswensens-production.appspot.com%2Fo%2Fbanner%252Fsw-banner.jpg%3Falt%3Dmedia&w=1920&q=75"
                alt=""
              />
            </div>
            ...
            <div className="flex justify-center items-center">
              <FontAwesomeIcon
                className="text-[#d1001f] hover:text-[#dd4057] text-xs mt-5"
                icon={faCircle}
              />
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
              <div className="group relative flex flex-col rounded-xl overflow-hidden border border-gray-300">
                <div className="relative">
                  <img
                    ...
                    alt="โปรโมชั่น มะม่วงอกร่องทอง"
                  />

                  <div className="absolute bottom-2 right-2 sm:hidden">
                    <button className="w-10 h-10 rounded-full bg-[#d1001f] text-white text-2xl shadow-lg flex items-center justify-center">
                ...
                <div className="flex items-center p-4">
                  <div>
                    ...
                    <p className="text-[#344054] font-bold text-xl">
                      โปรโมชั่น มะม่วงอกร่องทอง 3 ปอนด์ ราคาพิเศษ 699.-
                    </p>
                  </div>
                </div>
              ...
              <div className="group relative flex flex-col rounded-xl overflow-hidden border border-gray-300">
                ...
                {/* ส่วน select + ใส่ตะกร้า สำหรับหน้าจอ md ขึ้นไป */}
                <div
                  className="hidden md:flex absolute bottom-0 left-0 right-0 px-4 py-2 bg-white shadow-md rounded-b-xl
                    opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0
                    transition-all duration-300 justify-center"
                >
                  <div className="flex items-center h-10 overflow-hidden rounded-full shadow-md border border-[#d1001f] w-full max-w-xs relative">
              ...
              <div className="group relative flex flex-col rounded-xl overflow-hidden border border-gray-300">
                ...
                <div className="relative">
                  <img
                    ...
                    alt="โปรโมชั่น วันเดอร์ฟูลสตรอว์เบอรี่"
                  />
                ...
                <div className="flex items-center p-4">
                  <div>
                    <p className="text-[#d1001f] font-medium">฿ 699</p>
                    <p className="text-[#344054] font-bold text-xl">
                      โปรโมชั่น วันเดอร์ฟูลสตรอว์เบอรี่ 3 ปอนด์ ราคาพิเศษ 699.-
                    </p>
                  </div>
                </div>

                {/* ใส่ตะกร้า: แสดงเฉพาะบน md ขึ้นไป เมื่อ hover */}
                <div
                  className="hidden md:flex absolute bottom-0 left-0 right-0 px-4 py-2 bg-white shadow-md rounded-b-xl
                    opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0
                    transition-all duration-300 justify-center"
              ...
              <div className="group relative flex flex-col rounded-xl overflow-hidden border border-gray-300">
                ...
                <div className="relative">
                  <img
                    ...
                    alt="โปรโมชั่น ทริปเปิ้ล เฟล์เวอร์"
                  />
                ...
                <div className="flex items-center p-4">
                  <div>
                    <p className="text-[#d1001f] font-medium">฿ 699</p>
                    <p className="text-[#344054] font-bold text-xl">
                      โปรโมชั่น ทริปเปิ้ล เฟล์เวอร์ 3 ปอนด์ ราคาพิเศษ 699.-
                    </p>
                  </div>
                </div>

                {/* ส่วน select + ใส่ตะกร้า สำหรับเดสก์ท็อปขึ้นไป */}
                <div
                  className="hidden md:flex absolute bottom-0 left-0 right-0 px-4 py-2 bg-white shadow-md rounded-b-xl
                    opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0
                    transition-all duration-300 justify-center"
              ...
              <div className="group relative flex flex-col rounded-xl overflow-hidden border border-gray-300">
                ...
                <div className="flex items-center p-4">
                  <div>
                    ...
                    <p className="text-[#344054] font-bold text-xl">
                      Loe oream 2 Quarts (any flavors) only 449.-
                    </p>
                  </div>
                </div>

                {/* ดูรายละเอียด (แสดงบน hover เหมือนเดิม) */}
                <div
                  className="absolute bottom-0 left-0 right-0 px-4 py-2 bg-white shadow-md rounded-b-xl
                    opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0
                    transition-all duration-300 flex justify-center"
                >
                  <div className="bg-[#d1001f] text-white font-bold text-sm px-6 py-2 rounded-full hidden sm:flex">
                    ดูลายละเอียด
                  </div>
                </div>
              </div>
              ...
              <div className="group relative flex flex-col rounded-xl overflow-hidden border border-gray-300">
                ...
                <div className="flex items-center p-4">
                  <div>
                    ...
                    <p className="text-[#344054] font-bold text-xl">
                      ไอศกรีม 2 มินิ ควอท 379 บาท
                    </p>
                  </div>
                </div>

                {/* ปุ่มดูรายละเอียด: แสดงเฉพาะบนเดสก์ท็อป */}
                <div
                  className="hidden sm:flex absolute bottom-0 left-0 right-0 px-4 py-2 bg-white shadow-md rounded-b-xl
                    opacity-0 translate-y-full group-hover:opacity-100 group-hover:translate-y-0
                    transition-all duration-300 justify-center"
                >
